...
class EditorViewModel {
  ...
  static EditorViewModel converter(Store<AppState> store) {
    return EditorViewModel(
      ...
      startBookChangeHandler: (int bookId) =>
          store.dispatch(actions.startBookChangeHandler(bookId)),
      startChapterChangeHandler: (int chapter) =>
          store.dispatch(actions.startChapterChangeHandler(chapter)),
      startVerseChangeHandler: (int startVerse) =>
          store.dispatch(actions.startVerseChangeHandler(startVerse)),
      endBookChangeHandler: (int bookId) => store.dispatch(actions.endBookChangeHandler(bookId)),
      endChapterChangeHandler: (int chapter) =>
          store.dispatch(actions.endChapterChangeHandler(chapter)),
      endVerseChangeHandler: (int endVerse) =>
          store.dispatch(actions.endVerseChangeHandler(endVerse)),
    );
  }
}
